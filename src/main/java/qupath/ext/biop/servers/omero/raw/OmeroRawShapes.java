...
class OmeroRawShapes {
    ...
    public static List<ShapeData> convertQuPathRoiToOmeroRoi(PathObject src, String objectID, String parentID) {
        ...
        if (roi instanceof RectangleROI) {
            ...
            rectangle.setText(roi.getRoiName());
            ...
            ellipse.setText(roi.getRoiName());
            ...
            polyline.setText(roi.getRoiName());
            ...
            polygon.setText(roi.getRoiName());
            ...
            for (Point2 roiPoint : roiPoints) {
                ...
                point.setText(setRoiComment(roi.getRoiName()));
                point.setC(roi.getC());
                point.setT(roi.getT());
                point.setZ(roi.getZ());
                shapes.add(point);
